public class RemoveDuplicates {
    public static int removeDuplicates(int[] nums) {
        ...
        //inicializar writer en 1, que es el índice del siguiente elemento único
        int writer = 1;
        //Recorrer el array nums, empezando desde 1, si reader es menor que el tamaño del array nums, sumamos un elemento al array
